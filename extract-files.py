...
blob_fixups: blob_fixups_user_type = {
    ...
    ('odm/lib64/libarc_eis.so', 'odm/lib64/camera/components/com.oplus.node.eispreview.so', 'odm/lib64/camera/components/com.oplus.node.eisrecord.so'): blob_fixup()
        .add_needed('libc++_shared.so'),
    ('odm/lib64/libaiboost_hexagon.so', 'odm/lib64/libarcsoft_dualcam_refocus_frt_image.so', 'odm/lib64/libarcsoft_high_dynamic_range_v4.so', 'odm/lib64/libarcsoft_portrait_super_night_raw.so', 'odm/lib64/libarcsoft_turbo_fusion_raw_portrait_super_night.so', 'odm/lib64/libarcsoft_turbo_fusion_raw_super_night.so', 'odm/lib64/libarcsoft_super_night_raw.so'): blob_fixup()
    ...
    ('odm/lib64/libEIS.so', 'odm/lib64/libOPAlgoCamFaceBeautyCap.so', 'odm/lib64/libOGLManager.so'): blob_fixup()
